    ...
    <main>
        <div class="container-fluid mt-5">
            <div class="row">
                ...
                <div class="col-sm"><a href="<?= DOMAIN . 'public/index.php?controller=user&action=add' ?>" class="btn btn-primary"> Add <i class="fa-solid fa-plus"></i></a></div>
                    ...
                    <tbody>
                        ...
                        if (!empty($users))
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= DOMAIN . 'public/index.php?controller=user&action=delete&id=' . $user->getEmployeeID() ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this Department?')"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php
