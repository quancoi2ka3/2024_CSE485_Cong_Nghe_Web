...
class EmployeeController{
    ...
    public function add(){
        ...
        if(isset($_POST['employeeid'],$_POST['fullname'], $_POST['address'], $_POST['email'], $_POST['mobilephone'], $_POST['position'],$_POST['avatar'], $_POST['department_id'])){
            ...
            $success = true;
            header("Location: index.php?controller=employee&action=index&success=true");
            ...
            if($employee) {
                ...
                if(isset($_POST['submit'])) {
                    ...
                    if($result) {
                        ...
                        header('Location: ' . DOMAIN . 'public/index.php?controller=employee&action=index');
    ...
    public function search() {
        ...
        include APP_ROOT.'/app/views/employee/search.php';
    }    
